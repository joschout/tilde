...
class ExampleFormatHandler:
    ...
    def parse(self, internal_ex_format: InternalExampleFormat, fname_examples: str, possible_labels: List[Label],
    ...
    def _parse_ex_clausedb(self, fname_examples: str, possible_labels: List[Label],
                           background_knowledge: Optional[PrologFile] = None) -> List[Example]:
        raise NotImplementedError('Abstract method')

    def _parse_ex_simpleprogram(self, fname_examples: str, possible_labels: List[Label]) -> List[Example]:
        raise NotImplementedError('Abstract method')
