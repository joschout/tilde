...
def information_gain(example_list, sublist_left, sublist_right, list_of_possible_labels):
    ...
    ig = entropy(example_list, list_of_possible_labels)
...
def get_examples_satisfying_query(examples, query, background_knowledge):
